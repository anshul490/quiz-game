...
if(question_turn == 'player_1'){
    ...
    document.getElementById("player2").innerHTML = "Question turn - " + player2;

}

else{
    question_turn = player1;
    document.getElementById("player1").innerHTML = "Question turn - " + player1;

}

if(answer_turn == 'player1'){
answer_turn = player2;
document.getElementById("player2").innerHTML = "Answer turn - " + player2;

}
else{
    answer_turn = player1;
    document.getElementById("player1").innerHTML = "Answer turn - " + player1;
